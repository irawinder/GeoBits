 ...
 * This LSystem library is available at Kenai version 0.9.1
 ...
 * See version2 of this sketch for the new Turtle3D interface and the implementing class RodTurtle
 */
...
Grammar setupGrammar(int depth) {
