...
//      PVector starting = map.getLocation(network.getFloat(i, "y"), network.getFloat(i, "x"));
//      PVector ending = map.getLocation(network.getFloat(i+1, "y"), network.getFloat(i+1, "x"));
//        
//        x1 = starting.x;
//        x2 = ending.x;
//        y1 = starting.y;
