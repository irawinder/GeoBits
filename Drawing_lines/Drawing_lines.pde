...
This script generates a random network of POIs and edges and displays a looping animation of the edges traveling from their orgins to destination
This is an abstract component, but in the real visualization the POIs are cell phone towers and the edges are amounts of different nationalities going between them

Obviously you can change these colors to not match nationalities

The programmer can define the number of POIs generated, number of edges, the increment (speed), delay between loops and add more types/colors/langauges of the edges

Users can hover over a particular POI for information on it 

Users can click on a POI to see the animation of this POI's network 

Different key commands also toggle display options

This script uses two classes; POI and Edge 
